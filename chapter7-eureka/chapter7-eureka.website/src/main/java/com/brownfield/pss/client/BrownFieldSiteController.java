...
//		Flight[] flights = restClient.postForObject("http://localhost:8083/search/get", uiData.getSearchQuery(), Flight[].class);
		Flight[] flights = restClient.postForObject("http://search-service/search/get", uiData.getSearchQuery(), Flight[].class);
...
//			 bookingId = restClient.postForObject("http://localhost:8080/booking/create", booking, long.class);
...
// 		BookingRecord booking = restClient.getForObject("http://localhost:8080/booking/get/"+id, BookingRecord.class);
 		BookingRecord booking = restClient.getForObject("http://book-service/booking/get/"+id, BookingRecord.class);
